...
<html lang="en" itemscope itemtype="http://schema.org/WebPage"> <!--Change the lang property to your web's language-->
	...
	<body>
		<header>
			<nav class="nav top-m top-l top-xl md-depth-1 fixed">
				<img src="img/icon.svg" alt="Aegis Icon" class="logo">
    	...
    	{>{content}<}
    	<footer class="align-center padded-1">
			<p>Created by <a href="http://hyuchia.com">Hyuchia</a></p>
		</footer>
	</body>
</html>